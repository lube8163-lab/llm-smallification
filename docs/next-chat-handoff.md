...
4. Mac側で `./scripts/compile_coreml_probe_packages.sh <mlpackageのあるdir> <compiled出力dir>` を実行し、`./scripts/prepare_ios_coreml_probe_assets.sh <compiled出力dir>` でiOS targetへコピーしてください。
